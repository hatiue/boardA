...
<div>
    ...
    <form action="{{ route('create') }}" method="post" enctype="multipart/form-data">
        @csrf
        <label for="title"><span class="font-semibold">スレッドタイトル (64文字まで)</span></label>
        <input id="title" type="text" name="title" size="32" maxlength="64" class="block rounded focus:ring-2 focus:ring-orange-400 p-1"><br>
        @error('title', 'content')
